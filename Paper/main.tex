...
and~\citet{mckay1981subgraphs}, in the sparse regime $d^2=o(n)$, which
contains the headline setting $d=\Theta(\log n)$ used here,
...
every cell; this is expected, since full SND is the ground truth and
